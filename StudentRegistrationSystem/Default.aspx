    ...
    <main>
        ...
        <section class="stats-section mb-5">
            <div class="text-center mb-4">
                <h2 class="fw-bold"><i class="fas fa-chart-line me-2" style="color: #0077b6;"></i>Live Statistics</h2>
            ...
            <div class="row g-4">
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="ms-3">
                                    ...
                                    <h2 class="mb-0 fw-bold" style="color: #0077b6;"><asp:Label ID="lblTotalStudents" runat="server" Text="0"></asp:Label></h2>
                                </div>
                            </div>
                            <div class="progress" style="height: 8px;">
                                <div class="progress-bar" role="progressbar" style="width: 85%; background: linear-gradient(135deg, #0077b6 0%, #00b4d8 100%);" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-lg h-100" style="border-left: 5px solid #4facfe !important; transition: transform 0.3s;" onmouseover="this.style.transform='translateY(-10px)'" onmouseout="this.style.transform='translateY(0)'">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center mb-3">
                                <div class="icon-box" style="width: 60px; height: 60px; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border-radius: 15px; display: flex; align-items: center; justify-content: center;">
                                    <i class="fas fa-clipboard-check fa-2x text-white"></i>
                                </div>
                                <div class="ms-3">
                                    <h6 class="text-muted mb-0">Total Enrollments</h6>
                                    <h2 class="mb-0 fw-bold" style="color: #4facfe;"><asp:Label ID="lblTotalEnrollments" runat="server" Text="0"></asp:Label></h2>
                                </div>
                            </div>
                            <div class="progress" style="height: 8px;">
                                <div class="progress-bar" role="progressbar" style="width: 70%; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
        ...
        <section class="quick-actions mb-5">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm h-100 action-card" style="transition: all 0.3s;" onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 15px 35px rgba(79, 172, 254, 0.3)';" onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 2px 8px rgba(0,0,0,0.1)';">
                        <div class="card-body text-center p-5">
                            <div class="mb-4" style="width: 80px; height: 80px; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border-radius: 20px; display: flex; align-items: center; justify-content: center; margin: 0 auto;">
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="text-center">
                            <div class="mb-3" style="width: 60px; height: 60px; background: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                                <i class="fas fa-mobile-alt fa-2x" style="color: #4facfe;"></i>
                            </div>
